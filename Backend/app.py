...
for _service in SERVICES:
 _service['officialPortalUrl']='https://nadakacheri.karnataka.gov.in/'
 _service['officialSourceUrl']='https://s32ca65f58e35d9ad45bf7f3ae5cfd08f1.s3waas.gov.in/en/service-category/certificates/'
 _service['portalNotice']='AccessBridge guides you through the information. You will finish identity verification, CAPTCHA, payments, and final submission on the official Karnataka portal.'
SERVICES += [
 {'id':'caste-certificate','name':'Caste Certificate','category':'Karnataka Revenue','time':'10–15 minutes','description':'Prepare information commonly requested for a Karnataka caste certificate.','requiredInformation':['Identity details','Address','Community details','Supporting proof'],'officialPortalUrl':'https://nadakacheri.karnataka.gov.in/','officialSourceUrl':'https://s32ca65f58e35d9ad45bf7f3ae5cfd08f1.s3waas.gov.in/en/service-category/certificates/','portalNotice':'AccessBridge guides you through the information. You will finish identity verification, CAPTCHA, payments, and final submission on the official Karnataka portal.','fields':[{'id':'fullName','question':'What is your full name?','type':'text','required':True},{'id':'dateOfBirth','question':'What is your date of birth?','type':'date','required':True},{'id':'phone','question':'What is your 10-digit phone number?','type':'tel','required':True},{'id':'address','question':'What is your current address?','type':'textarea','required':True},{'id':'community','question':'What community or caste details are you applying under?','type':'text','required':True},{'id':'certificatePurpose','question':'Why do you need this certificate?','type':'textarea','required':True},{'id':'identityProof','question':'Which identity or residence proof will you provide?','type':'select','options':['Aadhaar card','Voter ID','Driving licence','Passport','Other'],'required':True}]},
 {'id':'birth-certificate-request','name':'Birth Certificate Request','category':'Karnataka Civil Registration','time':'8–12 minutes','description':'Prepare a request for a birth certificate through the appropriate local authority.','requiredInformation':['Person details','Birth place and date','Parent details','Registration information'],'officialPortalUrl':'https://www.gba.karnataka.gov.in/','officialSourceUrl':'https://www.gba.karnataka.gov.in/','portalNotice':'Birth and death services vary by local body. AccessBridge prepares your information; complete the final request on your local authority’s official portal.','fields':[{'id':'fullName','question':'What is the full name on the birth record?','type':'text','required':True},{'id':'dateOfBirth','question':'What is the date of birth?','type':'date','required':True},{'id':'birthPlace','question':'Where did the birth take place?','type':'text','required':True},{'id':'fatherName','question':'What is the father’s full name?','type':'text','required':True},{'id':'motherName','question':'What is the mother’s full name?','type':'text','required':True},{'id':'registrationNumber','question':'What is the birth registration number, if available?','type':'text','required':False},{'id':'phone','question':'What is your 10-digit phone number?','type':'tel','required':True}]}
]
SERVICES=[s for s in SERVICES if s['id']!='scholarship-application']
